        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    ...
                    <li class="nav-item"><a class="btn btn-outline-danger btn-sm" href="./login.php">Logout</a></li>
                </ul>
            </div>
        </div>
    </nav>
                            ...
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <?php if (!empty($row['images'])): ?>
                                        <img src="<?php echo htmlspecialchars($row['images']); ?>" class="post-img img-fluid" alt="">
                                    <?php else: ?>
