...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
  ...
  try {
    ...
    // Query failed — redirect or handle as needed
  ...
  if ($stmt && $stmt->rowCount() > 0) {
    ...
    // Blog not found, you can redirect or show an error message
    header("Location: blog.php");
    exit();
  }
}
...
<head>
  <title>AUNG THET TUN (ELECTRICAL & MACHINERY TRADING CO.,LTD)</title>
  <meta charset="utf-8">
...
<body>
      ...
      <div class="row">
        <div class="col-sm text-center text-md-left mb-md-0 mb-2 pr-md-4 d-flex topper align-items-center">
          <p class="mb-0 w-100 ">
            <span class="fa fa-envelope">
              <a href="mailto:yezawaung.attem@gmail.com">yezawaung.attem@gmail.com</a></span>
          </p>
        </div>
        ...
        <div
          ...
          <p class="mb-0 d-flex">
            ...
            <a href="https://www.tiktok.com/@attem318?_r=1&_t=ZS-910QVahFym8"
              class="d-flex align-items-center justify-content-center"><span
                class="fa fa-tumblr-square"><i class="sr-only">Tiktok</i></span></a>
            <a href="https://www.youtube.com/@AttemAKSA"
  ...
  <section class="hero-wrap hero-wrap-2" style="background-image: url('<?php echo isset($blog['images']) && $blog['images'] !== '' ? htmlspecialchars($blog['images'], ENT_QUOTES, 'UTF-8') : 'images/no-image-available-icon-vector.jpg'; ?>');" data-stellar-background-ratio="0.5">
      ...
      <div class="row no-gutters slider-text align-items-end justify-content-start">
        <div class="col-md-9 ftco-animate pb-5">
          <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i
                  ...
                  class="fa fa-chevron-right"></i></a></span> <span><?php echo $blog['name']; ?> <i
                class="fa fa-chevron-right"></i></span></p>
          <h1 class="mb-3 bread"><?php echo $blog['name']; ?></h1>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 ftco-animate">
          <img src="<?php
                    $img = isset($blog['images']) && $blog['images'] !== '' ? htmlspecialchars($blog['images'], ENT_QUOTES, 'UTF-8') : 'images/no-image-available-icon-vector.jpg';
                    echo $img;
                    ?>" alt="" style="width:400px;height:300px" class="img-fluid">
          <hr>
          <h2 class="mb-3"><span style="font-weight: bold;">Blog Description - </span><?php echo $blog['description']; ?></p>
            <h2 class="mb-3"><span style="font-weight: bold;">Created At - </span><?php echo $blog['created_at']; ?></p>
